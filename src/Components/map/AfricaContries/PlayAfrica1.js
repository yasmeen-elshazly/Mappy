...
import { countries } from '../../assests/africaData';
import SuccessModal from "./SuccessModal";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faStar } from '@fortawesome/free-solid-svg-icons';
import correctSound from '../../assests/Audio/Correct.mp3'
import incorrectSound from '../../assests/Audio/Incorrect.mp3'
    ...
    return (
        <div className="containerDiv">
            <div className="questionAndFlagContainer">
                ...
                <div className="score">
                    <FontAwesomeIcon className='starIcon' icon={faStar} size="1x" style={{ color: "#FFD43B" }} />
